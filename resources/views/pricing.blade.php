      ...
      <div class="col-md-12 ftco-animate">
        <div class="car-list">
          <table class="table">
            ...
            <tbody>
              <tr class="">
                <td class="car-image"><div class="img" style="background-image:url({{ asset('/sb')}}/images/car-1.jpg);"></div></td>
              ...
              <tr class="">
                <td class="car-image"><div class="img" style="background-image:url({{ asset('/sb')}}/images/car-2.jpg);"></div></td>
                <td class="product-name">
                  <h3>Cheverolet SUV Car</h3>
                  <p class="mb-0 rated">
                    <span>rated:</span>
              ...
              <tr class="">
                <td class="car-image"><div class="img" style="background-image:url({{ asset('/sb')}}/images/car-3.jpg);"></div></td>
                <td class="product-name">
                  <h3>Cheverolet SUV Car</h3>
                  <p class="mb-0 rated">
                    <span>rated:</span>
              ...
              <tr class="">
                <td class="car-image"><div class="img" style="background-image:url({{ asset('/sb')}}/images/car-4.jpg);"></div></td>
                <td class="product-name">
                  <h3>Cheverolet SUV Car</h3>
                  <p class="mb-0 rated">
                    <span>rated:</span>
              ...
              <tr class="">
                <td class="car-image"><div class="img" style="background-image:url({{ asset('/sb')}}/images/car-5.jpg);"></div></td>
                <td class="product-name">
                  <h3>Cheverolet SUV Car</h3>
                  <p class="mb-0 rated">
                    <span>rated:</span>
              ...
              <tr class="">
                <td class="car-image"><div class="img" style="background-image:url({{ asset('/sb')}}/images/car-6.jpg);"></div></td>
                <td class="product-name">
                  <h3>Cheverolet SUV Car</h3>
                  <p class="mb-0 rated">
                    <span>rated:</span>
