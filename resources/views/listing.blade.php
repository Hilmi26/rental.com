      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="{{ asset('sb/images/car_3.jpg')}}" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Skoda Laura</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="{{ asset('sb/images/car_2.jpg')}}" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Mazda LaPuta</h3>
                <div class="rent-price">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="{{ asset('sb/images/car_1.jpg')}}" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="{{ asset('sb/images/person_1.jpg')}}" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="{{ asset('sb/images/person_2.jpg')}}" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="{{ asset('sb/images/person_3.jpg')}}" alt="Image" class="img-fluid mr-3">
                <div class="author-name">
