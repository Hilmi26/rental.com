@include('../layouts/navbar')
    ...
    <div class="hero-wrap ftco-degree-bg" style="background-image: url('{{ asset('/sb')}}/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('/sb')}}/images/image_1.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url('{{ asset('/sb')}}/images/image_3.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
                  <div><a href="#">Oct. 29, 2019</a></div>
